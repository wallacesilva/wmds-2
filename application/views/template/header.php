...
<!--[if IE]>
<link rel="stylesheet" media="all" type="text/css" href="media/css/pro_dropline_ie.css" />
<![endif]-->
...
$(function() {
	...
	image: "media/images/forms/upload_file.gif",
	imageheight : 29,
	imagewidth : 78,
	width : 300
	});
...
<div class="nav-outer"> 
		...
		<div id="nav-right">
			...
			<div class="showhide-account"><img src="media/images/shared/nav/nav_myaccount.gif" width="93" height="14" alt="" /></div>
			<div class="nav-divider">&nbsp;</div>
			<a href="" id="logout"><img src="media/images/shared/nav/nav_logout.gif" width="64" height="14" alt="" /></a>
			<div class="clear">&nbsp;</div>
